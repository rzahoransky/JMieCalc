...
public class SiO2inAir extends AbstractMieParticlePreset {
	...
	public SiO2inAir() {
		...
		refractiveIndexSphereReal.put(Wavelengths.WL1, 1.4559);
		refractiveIndexSphereReal.put(Wavelengths.WL2, 1.453);
		refractiveIndexSphereReal.put(Wavelengths.WL3, 1.4468);
