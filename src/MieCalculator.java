...
public class MieCalculator {
	...
	public MieCalculator(CalculationAssignment parameters) throws InterruptedException, IllegalMieListException, WavelengthMismatchException, IOException {
